data = load('disease_0622.mat');
diseaseDataset = data.disease;

%idx = floor(0.8 * height(tomatoDataset));
trainingData = diseaseDataset(1:3,:);
testData = diseaseDataset(4:4,:);
%%
...
finalLayers = [
    ...
    fullyConnectedLayer(width(diseaseDataset))
